    ...
    <div class="bg-white font-sans text-black px-4 sm:px-6 md:px-10 lg:px-16 py-6">
        <div class="max-w-7xl mx-auto">
            <section class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 mb-12">
                ...
                >
                    <header class="bg-red-100 rounded-t-xl px-6 py-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-red-800 font-extrabold text-lg leading-5">
                                    Study Tour
                                </h2>
                                <p class="text-red-800 text-xs font-semibold leading-4">
                    ...
                    <section class="px-6 py-4 border-b border-gray-200 relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="italic font-normal text-sm text-gray-600">Male: {{ application.study_tour_details.male }}</p>
                                <p class="italic font-normal text-sm text-gray-600">Female: {{ application.study_tour_details.female }}</p>
                            </div>
                            <span
                                :class="[
                ...
                <div class="flex flex-col space-y-6 flex-1 max-w-lg w-full">
                  ...
                  >
                        <div class="cursor-pointer" @click="handleOpenDocument(application.study_tour_details.institution_approval)">
                            <p class="text-gray-600 flex items-center space-x-2 text-sm">
                                ...
                                <span>Institution Approval Letter</span>
                            </p>
                        </div>
