    ...
    <div class="bg-white font-sans text-black px-4 sm:px-6 md:px-10 lg:px-16 py-6">
        <div class="max-w-7xl mx-auto">
            <section class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 mb-12">
                ...
                >
                    <header class="bg-[#E0F3FF] rounded-t-xl px-6 py-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-[#0073FF] font-extrabold text-lg leading-5">
                                    Medical
                                </h2>
                                <p class="text-[#0073FF] text-xs font-semibold leading-4">
                    ...
                    <section class="px-6 py-4 border-b border-gray-200 relative">
                        <div class="flex justify-between items-start">
                            <div>
                                ...
                                <p class="text-sm leading-5 mt-1">
                                    {{application.medical_details[0].category}}
                                </p>
                            </div>
                            <span
                                :class="[
...
<!--            Patient Table-->
            <section v-if="application.medical_details.filter(m => m.category === 'Patient').length !== 0" class="overflow-x-auto">
                ...
                <table class="w-full border-collapse ">
                    ...
                    <tr class="bg-gray-700 text-white text-xs font-bold text-left">
                        ...
                        <th class="py-2 px-3 whitespace-normal">CATEGORY</th>
                        <th class="py-2 px-3 whitespace-normal">SERVICE</th>
                    ...
                    <tr  v-for="member in application.medical_details.filter(m => m.category === 'Patient')"
                         :key="member.id"
                        class="border-l-4 border-gray-900 vertical-line">
                        <td class="py-3 px-3 max-w-[120px] leading-5 break-words whitespace-normal">
                            {{ member.name }}
                        </td>
                        <td class="py-3 px-3 whitespace-nowrap">{{ member.category }}</td>
                        <td class="py-3 px-3 whitespace-nowrap">{{ member.service }}</td>
            ...
            <section v-if="application.medical_details.filter(m => m.category === 'Attendant').length !== 0" class="overflow-x-auto">
                ...
                <table class="w-full border-collapse ">
                    ...
                    <tbody class="text-xs text-gray-900">
                    <tr  v-for="member in application.medical_details.filter(m => m.category === 'Attendant')"
                         :key="member.id"
                         class="border-l-4 border-gray-900 vertical-line">
                        <td class="py-3 px-3 max-w-[120px] leading-5 break-words whitespace-normal">
                            {{ member.name }}
