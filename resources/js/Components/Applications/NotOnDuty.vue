    ...
    <div class="bg-white font-sans text-black px-4 sm:px-6 md:px-10 lg:px-16 py-6">
        <div class="max-w-7xl mx-auto">
            <section class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 mb-12">
                ...
                >
                    <header class="bg-green-100 rounded-t-xl px-6 py-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-green-800 font-extrabold text-lg leading-5">
                                    NOT ON DUTY
                                </h2>
                                <p class="text-green-800 text-xs font-semibold leading-4">
            ...
            <section v-if="application.not_on_duty_details.length !== 0" class="overflow-x-auto">
                ...
                <table class="w-full border-collapse ">
                    ...
                    <tr v-for="member in application.not_on_duty_details" :key="member.id"
