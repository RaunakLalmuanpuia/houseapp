...
<!--            <div class="p-4 rounded-lg shadow-md" style="background: #FFF3E0">-->
<!--                <div class="flex justify-between items-center">-->
<!--                    <div>-->
<!--                        <h2 class="text-primary font-bold text-xl">FLAM</h2>-->
...
<!--                        <span class="font-bold">{{ application.application_id }}</span>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->

<!--            <div class="p-4  text-foreground mt-4">-->
<!--                <div class="flex justify-between items-center mb-2">-->
<!--                    <h1 class="text-xl font-bold">-->
<!--                        {{ application.applicant_name }},-->
<!--                        <span class="font-light">{{ application.gender }}</span>-->
<!--                    </h1>-->
<!--                    <span class="inline-block bg-accent text-accent-foreground text-sm rounded-full px-3 py-1 ml-4 whitespace-nowrap bg-yellow-200 text-zinc-700">-->
<!--                    {{ application.status }}-->
<!--                </span>-->
<!--                    &lt;!&ndash;                    <span class="bg-zinc-200 text-zinc-700 px-2 py-1 rounded-full text-sm">Estimated Amount</span>&ndash;&gt;-->
<!--                </div>-->
...
<!--                    </div>-->
<!--                    <div>-->
<!--                        <span class="text-muted-foreground block">Destination</span>-->
<!--                        <span class="font-bold">{{ application.location }}</span>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
<!--        </div>-->
...
<!--    </div>-->
<!--    &lt;!&ndash;    Other Official Table&ndash;&gt;-->
<!--    <div v-if="application.flam_details.length !== 0" class="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 mt-4">-->
<!--        <h2 class="text-2xl font-bold mb-4">Another FLAM</h2>-->
...
<!--                </thead>-->
<!--                <tbody>-->
<!--                <tr class="bg-zinc-100" v-for="member in application.flam_details" :key="member.id" >-->
<!--                    <td class="py-2 px-4 border-b text-left">{{member.flam_name}}</td>-->
...
<!--    &lt;!&ndash;    Other Family Table&ndash;&gt;-->
    ...
    <div class="bg-white font-sans text-black px-4 sm:px-6 md:px-10 lg:px-16 py-6">
        <div class="max-w-7xl mx-auto">
            <section class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 mb-12">
                ...
                >
                    <header class="bg-yellow-200 rounded-t-xl px-6 py-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-yellow-800 font-extrabold text-lg leading-5">
                                    FLAM
                                </h2>
                                <p class="text-yellow-800 text-xs font-semibold leading-4">
            ...
            <section v-if="application.flam_details.length !== 0" class="overflow-x-auto">
                <h4 class="font-semibold mb-4 text-base">Another FLAM Members</h4>
                <table class="w-full border-collapse ">
                    ...
                    <tr v-for="member in application.flam_details" :key="member.id"
