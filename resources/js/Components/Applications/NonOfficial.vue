    ...
    <div class="bg-white font-sans text-black px-4 sm:px-6 md:px-10 lg:px-16 py-6">
        <div class="max-w-7xl mx-auto">
            <section class="flex flex-col md:flex-row md:space-x-6 space-y-6 md:space-y-0 mb-12">
                ...
                >
                    <header class="bg-orange-100 rounded-t-xl px-6 py-4">
                        <div class="flex justify-between items-center">
                            <div>
                                <h2 class="text-orange-400 font-extrabold text-lg leading-5">
                                    Private
                                </h2>
                                <p class="text-orange-400 text-xs font-semibold leading-4">
                                    Non-official personal stay
                                </p>
                            </div>
            ...
            <section v-if="application.non_official_details.length !== 0" class="overflow-x-auto">
                <h4 class="font-semibold mb-4 text-base">Another Persons</h4>
                <table class="w-full border-collapse ">
                    ...
                    <tr v-for="member in application.non_official_details" :key="member.id"
