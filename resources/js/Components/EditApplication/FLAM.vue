...
const form = useForm({
    ...
    department_approval: props.application.department_approval,
...
function addFlam() {
    form.flam_details.push({ flam_name: '', gender: '', contact: '', designation: '' })
}

function removeFlam(index) {
    form.flam_details.splice(index, 1)
}
