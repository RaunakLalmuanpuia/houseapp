...
<template>
        ...
        >
            ...
            <div class="space-y-6">
                ...
                <div class="flex justify-start space-x-6 pt-2">
                    ...
                    <button
                        @click="updateHouse(selectedHouse)"
                        type="submit"
    ...
    <div v-if="showDeleteDialog"
        ...
        <div class="bg-white rounded-xl max-w-sm w-full p-6">
            <h2 class="font-semibold text-lg mb-4">Delete Mizoram House</h2>
            <p class="mb-8 text-base font-normal text-gray-900">I am sure, that i want to delete this Mizoram House</p>
            <div class="flex space-x-4">
                ...
                <button
                    @click="deleteHouse(selectedHouse)"
                    type="button"
        ...
        >
            ...
            <div class="flex-1">
                ...
                <p class="text-green-900 text-base leading-6 mt-1">
                    Mizoram House created successfully!
                </p>
            </div>
            <button
        ...
        >
            ...
            <div class="flex-1">
                ...
                <p class="text-yellow-900 text-base leading-6 mt-1">
                    Mizoram House updated successfully!
                </p>
            </div>
            <button
        ...
        >
            ...
            <div class="flex-1">
                ...
                <p class="text-red-900 text-base leading-6 mt-1">
                    Mizoram House deleted successfully!
                </p>
            </div>
            <button
