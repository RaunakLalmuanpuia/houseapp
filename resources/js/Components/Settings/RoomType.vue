...
function handleSearch(val) {
    getRoomType({ pagination: pagination.value, filter: val });
}
function clearSearch() {
    filter.value = ''; // Clear the search value
    // Reset the pagination if needed (e.g., set page to 1 after clearing search)
    pagination.value.page = 1;
    getRoomType({ pagination: pagination.value, filter: '' }); // Clear the filter in the API request
}
function getRoomType(props) {
    const { page, rowsPerPage, sortBy, descending } = props.pagination;
    const filter = props.filter;

    axios.get(route('admin.room_type.index'), {
        params: {
            filter,
            page,
            rowsPerPage,
...
<!--        {{houses}}-->
        ...
        >
            <h3 class="font-bold text-lg mb-6">Add Room Type</h3>
        ...
        <section class="max-w-4xl space-y-4">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <h3 class="font-bold text-lg mb-3 sm:mb-0">List of Room Type</h3>
                <div
            ...
            <table class="w-full border-collapse text-sm">
                ...
                <tr class="bg-gray-700 text-white text-left">
                    ...
                    <th class="py-2 px-3 font-semibold w-[40%]">ROOM TYPE</th>
                    <th class="py-2 px-3 font-semibold w-[40%]">HOUSE</th>
                ...
                <tr
                    ...
                    <td class="py-2 px-3">{{ item.house.name }}</td>
    ...
    <div v-if="showDeleteDialog"
        ...
        <div class="bg-white rounded-xl max-w-sm w-full p-6">
            <h2 class="font-semibold text-lg mb-4">Delete Room Type</h2>
            <p class="mb-8 text-base font-normal text-gray-900">I am sure, that i want to delete this Room Type</p>
