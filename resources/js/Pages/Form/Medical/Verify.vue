...
function submit() {
    form.post(route('apply.medical.submit'), {
        onSuccess: () => {
            application.reset()
        },
        onError: (errors) => {
...
function resendOtp(){
    router.get(route('apply.medical.verify'), {
            ...
            <div class="max-w-md w-full">
                <div class="bg-white border border-gray-300 rounded-xl p-8">
                    ...
                    <p class="text-gray-500 text-sm mb-6">
                        ...
                        <span @click="$inertia.get(route('apply.medical.step-two'))" class="text-green-600 cursor-pointer">(Edit)</span>
                    </p>
