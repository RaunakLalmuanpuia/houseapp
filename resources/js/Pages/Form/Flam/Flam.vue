    ...
    <div class="min-h-screen flex flex-col">
        ...
        <div class="flex-grow flex flex-col items-center w-[400px] mx-auto p-3">
            ...
            <div class="max-w-md w-full rounded-xl border border-gray-200 overflow-hidden">
                <header class="bg-[#FDEED6] p-6 rounded-t-xl">
                    <h1 class="text-[#7B4F1B] font-extrabold text-xl leading-6">FLAM</h1>
                    <p class="text-[#7B4F1B] font-semibold text-sm leading-5 mt-1">Former Legislators Association of Mizoram</p>
                </header>
                <div class="bg-white p-6 space-y-6">
                    ...
                    <div v-if="application.flam_details && application.flam_details.length > 0">
                        <h2 class="font-bold text-lg leading-6 border-l-4 border-black pl-2">FLAM Member</h2>
                    </div>

                    <div v-for="(flam, index) in application.flam_details" :key="index">

                        <p class="text-muted-foreground text-s py-2">Other FLAM member</p>

                        <div>
                            <label for="applicant" class="block font-semibold text-sm leading-5 mb-1 text-black">Applicant Name</label>
                            <input
                                v-model="flam.flam_name"
                                id="applicant"
                                type="text"
                                placeholder="Diltu Hming"
                                class="w-full rounded-md border border-gray-300 text-gray-400 placeholder-gray-400 px-4 py-2 text-base leading-6 focus:outline-none focus:ring-2 focus:ring-black focus:border-black"
                    ...
                    <div class="flex justify-between mt-4">
                        <button
                            @click.prevent="application.addFlam()"
                            type="button"
