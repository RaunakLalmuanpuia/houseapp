...
const props = defineProps(['users','houses','userRoles','search', 'perPage']);
    ...
    <div class="bg-white text-black">
        <div class="ml-6">
            <header class="flex justify-between items-center mb-6">
                <h1 class="font-semibold text-base leading-5">Users</h1>
            ...
            <section class="flex flex-col md:flex-row gap-6">
                <!-- Left panel -->
                <aside class="bg-[#E8F2FD] rounded-lg p-6 w-full max-w-[320px] max-h-[600px]" >
                    <h2 class="font-semibold text-lg leading-6 mb-1">Set User Role</h2>
                    <p class="text-xs leading-4 mb-6">Create user and assign permissions</p>
                    <div class="space-y-5">
                        <div>
                            <label for="name" class="block text-xs font-normal mb-1">User Name</label>
                            <input
                                v-model="form.name"
                                id="name"
                                type="text"
                        ...
                        <div>
                            <label for="email" class="block text-xs font-normal mb-1">Email ID</label>
                            <input
                                v-model="form.email"
                                id="email"
                                type="email"
                        ...
                        <div>
                            <label for="password" class="block text-xs font-normal mb-1">Password</label>
                            <input
                ...
                <section class="flex-1 overflow-x-auto">
                    <table class="w-full border-collapse text-xs leading-5">
                        ...
                        <tr class="bg-gray-800 text-white text-left">
                            ...
                            <th class="py-2 px-3 font-semibold w-[12%]">USERNAME</th>
                            <th class="py-2 px-3 font-semibold w-[20%]">EMAIL ID</th>
                            <th class="py-2 px-3 font-semibold w-[20%]">PHONE NO</th>
                            <th class="py-2 px-3 font-semibold w-[12%]">HOUSE</th>
                            <th class="py-2 px-3 font-semibold w-[12%]">ROLE</th>
