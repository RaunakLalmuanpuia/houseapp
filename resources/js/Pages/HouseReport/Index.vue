...
const fetchData = (url = route('house.report.json-index')) => {
    axios.get(url, {
        params: {
            search: state.search,
...
const exportReport = () => {
    ...
    axios.get(route('house.report.export'), {
        params: {
            ...state.filters,
        },
        responseType: 'blob' })
...
const downloadReport = () => {
    // Make a GET request to the URL with responseType as 'blob'
    axios.get(route('house.report.download'), {
        params: {
            ...state.filters,
        },
        responseType: 'blob' })
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-6 max-w-full ml-12 mr-12">
                <div class="flex flex-col">
                    ...
                    >
                        ...
                        <option value="Forwarded" class="text-gray-400">Incoming</option>
