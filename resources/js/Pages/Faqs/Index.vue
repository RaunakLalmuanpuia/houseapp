...
const props = defineProps(['faqs','search', 'perPage']);
...
const selectedFaq = ref({}) // optional, used for display if needed
...
const handleSearch = () => {
    router.get(route('admin.faq.index'), {
        search: state.search,
...
const updateFaq =(item) => {
    editForm.put(route('admin.faq.update', item), {
        onStart: () => {
            // editForm.reset();
...
const deleteFaq = (item) => {
    ...
    router.delete(route('admin.faq.destroy', item), {
        onSuccess: () => {
...
<template>
    ...
    <div class="bg-white text-black">
        ...
        <header class="flex justify-between items-center mb-6">
            <h1 class="font-semibold text-base leading-5">Frequently Asked Questions (FAQs)</h1>
        ...
        <section class="flex flex-col md:flex-row gap-6">
            ...
            <aside class="bg-[#E8F2FD] rounded-lg p-6 w-full max-w-[320px] max-h-[500px]" >
                <h2 class="font-semibold text-lg leading-6 mb-1">Add FAQs</h2>
                <p class="text-xs leading-4 mb-6">Add new Frequently Asked Questions (FAQs)</p>
                <div class="space-y-5">
                    <div>
                    ...
                    <div>
                        <label for="content" class="block text-xs font-normal mb-1">Content</label>
                        <textarea
                            v-model="form.content"
                            id="content"
                            rows="4"
                            placeholder="Type here"
                            class="w-full rounded border border-gray-300 px-3 py-2 text-xs placeholder:text-gray-400 resize-none focus:outline-none focus:ring-1 focus:ring-blue-500"
                        ></textarea>
                    </div>
                    <div>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <textarea
                    ...
                    rows="4"
                    placeholder="Type here"
                    class="block w-full rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 text-gray-900 resize-none focus:outline-none focus:ring-1 focus:ring-blue-600 focus:border-blue-600 text-sm"
                ></textarea>
            </div>
            <div>
                <label
...
<!--    Confirm Reject Dialog-->
    <div v-if="showDeleteDialog"
        ...
        <h2 class="font-semibold text-lg mb-4">Delete FAQ</h2>
        <p class="mb-8 text-base font-normal text-gray-900">I am sure, that i want to delete this FAQ</p>
